<template>
  <Layout>
    ...
    <section class="my-4 px-4 sm:px-4 md:px-4">
      ...
      <div
      class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5 py-2"
      >
      <!-- Category 1 -->
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Earrings" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Necklaces" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Bracelets" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Rings" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Bags" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Scarves" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Watches" class="w-full h-full object-cover" />
        </div>
      ...
      <a href="#" class="flex flex-col items-center space-y-2 bg-white rounded-lg transition">
        <div class="w-full aspect-square mb-2 rounded overflow-hidden flex items-center justify-center bg-gray-100">
        <img src="https://placehold.co/250" alt="Shoes" class="w-full h-full object-cover" />
        </div>
    ...
    >
      <h2 class="text-2xl font-medium text-center mb-6 flex items-center justify-center">
      <span class="inline-block align-middle w-16 h-0.5 bg-orange mr-4"></span>
      Pinterest-Inspired Hair Accessories
      <span class="inline-block align-middle w-16 h-0.5 bg-green ml-4"></span>
      </h2>
      <div class="relative">
      <!-- Prev Button -->
